...
class dashboardLib{
	public function printHeader($isSubdirectory = true){
		...
		echo '			<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
						...
						<title>[Beta] JustinGDPS Dashboard</title>
	...
	public function printNavbar($active){
		...
		echo '<nav class="navbar navbar-expand-lg navbar-dark menubar">
			<a class="navbar-brand" href="index.php">JustinGDPS</a>
			...
			if($gs->checkPermission($_SESSION["accountID"], "dashboardModTools")){
				echo '<li class="nav-item dropdown '.$modActive.'">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							...
							<a class="dropdown-item" href="../tools/packCreate.php">'.$this->getLocalizedString("packCreate").' (T)</a>
						</div>
					</li>';
			}
		}else{
